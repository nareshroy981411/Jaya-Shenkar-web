    ...
    >
      ...
      <div className="md:w-1/2 space-y-3 md:space-y-4">
        <div className="flex items-center justify-between">
          ...
          {project.theme === "industrial" && <Building2 className="w-5 h-5" />}
          {project.theme === "paper" && <Factory className="w-5 h-5" />}
          {project.theme === "power" && <Zap className="w-5 h-5" />}
        </div>
