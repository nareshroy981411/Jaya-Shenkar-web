...
//     images: [
//       'https://source.unsplash.com/400x300/?industrial',
//       'https://source.unsplash.com/400x300/?factory',
//       'https://source.unsplash.com/400x300/?industry'
//     ]    },
//     {
...
//     },
//     {
//       title: 'Konta Pulp & Paper Mill',
//       location: 'Sukma District, Chhattisgarh',
//       status: 'Planning Phase',
//       sector: 'Pulp & Paper',
//       theme: 'paper',
//       href: '/business/paper/konta',
//     images: [
//       'https://source.unsplash.com/400x300/?industrial',
//       'https://source.unsplash.com/400x300/?factory',
//       'https://source.unsplash.com/400x300/?industry'
...
//           { text: 'Investment Opportunities', href: '/investors', variant: 'outline' }
//         ]}
//       />
...
//                     <span className={`px-3 py-1 rounded-full text-xs font-medium ${project.theme === 'industrial' ? 'bg-[hsl(var(--industrial-light))] text-[hsl(var(--industrial-primary))]' :
//                         project.theme === 'paper' ? 'bg-[hsl(var(--paper-light))] text-[hsl(var(--paper-primary))]' :
//                           'bg-[hsl(var(--power-light))] text-[hsl(var(--power-primary))]'
//                       }`}>
//                       {project.sector}
//                     </span>
//                     {project.theme === 'industrial' && <Building2 className="w-5 h-5 text-[hsl(var(--industrial-accent))]" />}
//                     {project.theme === 'paper' && <Factory className="w-5 h-5 text-[hsl(var(--paper-accent))]" />}
//                     {project.theme === 'power' && <Zap className="w-5 h-5 text-[hsl(var(--power-accent))]" />}
//                   </div>
...
const projects = [
  ...
  },
  {
    ...
    images: [
      ...
      "https://plus.unsplash.com/premium_photo-1678743133491-dc8b8713daa3?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      "/power/tunnel-1.png",
    ]
  },
  {
